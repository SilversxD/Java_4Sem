...
public class Main {
    ...
    public static void main(String[] args) {
        List<Human> people = new ArrayList<Human>() {{
            ...
            add(new Human(19, "Ulyana", "Vladyko", LocalDate.of(2001, 12, 1), 72));
            add(new Human(18, "Maxim", "Bychkov", LocalDate.of(2003, 5, 17), 70));
            add(new Human(21, "Stepan", "Kondalenko", LocalDate.of(2002, 2, 3), 63));
        }};
